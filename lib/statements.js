...
{
	column: symbol.Identifier,
	plus: type.union(symbol.IntTerm, symbol.SetLiteral, symbol.ListLiteral),

	format: "{{column}} = {{column}} + {{plus}}"
});
...
var ColumnList = type.union(type.literal('*'), type.collection(SelectedId));
